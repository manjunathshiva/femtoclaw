...
esp_err_t context_build_system_prompt(char *buf, size_t size)
{
    ...
    off += snprintf(buf + off, size - off,
        ...
        "- gpio_control: Control GPIO pins. Use action='set' with level=0 or 1 to drive LEDs/relays/buzzers. "
        "Use action='read' to read a pin's current level. Only safe pins are allowed.\n\n"
