...
esp_err_t context_build_system_prompt(char *buf, size_t size)
{
    ...
    off += snprintf(buf + off, size - off,
        ...
        "To schedule at a specific time: call get_current_time first, then compute at_epoch = epoch + offset_seconds.\n"
        "Example: if epoch=1740835800 and user says '4:45 PM' (15 min from now), use at_epoch=1740835800+900=1740836700.\n\n"
