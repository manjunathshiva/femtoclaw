...
Edit `main/femto_secrets.h` — fill in ALL required fields:

```c
#define FEMTO_SECRET_WIFI_SSID       "YourWiFiName"        // REQUIRED
#define FEMTO_SECRET_WIFI_PASS       "YourWiFiPassword"     // REQUIRED
#define FEMTO_SECRET_TG_TOKEN        "123456:ABC-DEF..."    // REQUIRED
#define FEMTO_SECRET_API_KEY         "sk-ant-api03-..."     // REQUIRED
#define FEMTO_SECRET_MODEL           ""                     // optional, defaults to claude-opus-4-5
#define FEMTO_SECRET_SEARCH_KEY      ""                     // optional: Brave Search API key
#define FEMTO_SECRET_PROXY_HOST      ""                     // optional: e.g. "192.168.1.83"
#define FEMTO_SECRET_PROXY_PORT      ""                     // optional: e.g. "7897"
```
...
**IMPORTANT:** Always `fullclean` after changing `femto_secrets.h` — the secrets are compiled into the binary.
...
2. Send: `Hello`
3. You should see "femto is working..." followed by a response
